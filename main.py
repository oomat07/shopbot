...
from utils import db_add_category, db_add_product, db_get_categories, db_get_products_by_category, create_tables
token = "6878337813:AAGzrZNBYim_aZ5VPnU-I1yX7YWaK9DB7w8"
admin_id = 6855283297
bot = Bot(token=token, parse_mode="HTML")
dp = Dispatcher()

@dp.message(Command("start"))
async def start_handler(messge : types.Message):
    await messge.answer("hello")
